 ...
 * step. Administrator plumbing comes first on purpose: an admin who enters
 * Google credentials here can then use OAuth in the account step two stops
 * later, which is not possible the other way round.
 *
