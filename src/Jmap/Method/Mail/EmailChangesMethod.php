...
/**
 * "Email/changes" (RFC 8621 §4.3). Same shape as Mailbox/changes — the change
 * log does the work — minus the updatedProperties member, which the spec only
 * defines for Mailbox.
 */
final class EmailChangesMethod implements JmapMethod
{
