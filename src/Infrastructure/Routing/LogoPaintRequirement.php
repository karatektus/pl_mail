 ...
 * LogoMotif::paintWires(), the vocabulary the export walks too.
 *
 ...
 * icon. Symfony's EnumRequirement does this for a whole enum; the paint
 * vocabulary is an enum plus the one word no case of it carries.
 */
final class LogoPaintRequirement implements \Stringable
{
    public function __toString(): string
    {
        return implode('|', array_map(preg_quote(...), LogoMotif::paintWires()));
    }
}
