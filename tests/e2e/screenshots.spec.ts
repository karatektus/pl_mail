...
test.describe("README screenshots", () => {
    ...
    test("calendar", async ({ page }) => {
        ...
        // nothing about a week view. Dates are relative to today, the first of
        // the seven days it shows, so the picture is the same shape whenever it
        // is taken.
        ...
        //     out as yesterday, which walks the first day's events off the
        //     week view.
