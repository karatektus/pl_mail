 ...
 */
final class Version20260717160332 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE account ALTER gmail_sync_gmailify_enabled DROP DEFAULT');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE account ALTER gmail_sync_gmailify_enabled SET DEFAULT false');
